...
import { Navbar, Image,Nav,NavItem } from 'react-bootstrap/lib'
...
class SearchBar extends Component {
  ...
  return (
    <Navbar bsStyle='inverse'>
      ...
      <Navbar.Header>
        <Navbar.Brand>
          <a href="#/home"><span style={brandStyle}>{this.props.brand}</span><Image style={imgStyle} /></a>
        </Navbar.Brand>
        <Navbar.Brand>
          <a href="#/vintage"><span style={brandStyle}>Vintage</span><Image style={imgStyle} /></a>
        </Navbar.Brand>
      </Navbar.Header>
      ...
      <i onClick={this.handleLogout} className="fa-solid fa-right-from-bracket" title="Logout" style={{color:"white", cursor:"pointer",fontSize:"140%"}}></i>
    </Navbar>
  );
